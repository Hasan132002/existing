                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            <h2 class="title">Celebrity List</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{url('Index')}}">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Celebrity List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="ceb-item-style-2">
                                        <img src="{{$cast->Actresses_Img}}" style="width:140px;height:180px" alt="">
                                        <div class="ceb-infor">
                                            <h2><a href="#">{{$cast->Actresses_Name}}</a></h2>
                                            <span>actor</span>
                                            <p>{{$cast->Actresses_Des}}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="ceb-item-style-2">
                                        <img src="{{$cast->Actors_Img}}" style="width:140px;height:180px" alt="">
                                        <div class="ceb-infor">
                                            <h2><a href="#" >{{$cast->Actors_Name}}</a></h2>
                                            <span>actor</span>
                                            <p>{{$cast->Actors_Des}}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="rc-post">
                                    <ul>
                                        <li class="rc-post-item">
                                            <div class="thumb">
                                                <a href="="#""><img src="public/img/blog/rc_post_thumb01.jpg" alt=""></a>
                                            </div>
                                            <div class="content">
                                                <h5 class="title"><a href="#">Express Management Effective</a></h5>
                                                <span class="date"><i class="far fa-clock"></i> 10 Mar 2021</span>
                                            </div>
                                        </li>
                                        <li class="rc-post-item">
                                            <div class="thumb">
                                                <a href="#"><img src="public/img/blog/rc_post_thumb02.jpg" alt=""></a>
                                            </div>
                                            <div class="content">
                                                <h5 class="title"><a href="#">>Where watch English movies free?</a></h5>
                                                <span class="date"><i class="far fa-clock"></i> 10 Mar 2021</span>
                                            </div>
                                        </li>
                                        <li class="rc-post-item">
                                            <div class="thumb">
                                                <a href="#"><img src="public/img/blog/rc_post_thumb03.jpg" alt=""></a>
                                            </div>
                                            <div class="content">
                                                <h5 class="title"><a href="#">>House movie streaming website</a></h5>
                                                <span class="date"><i class="far fa-clock"></i> 10 Mar 2021</span>
                                            </div>
                                        </li>
                                    </ul>
