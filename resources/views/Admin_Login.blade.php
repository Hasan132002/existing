			...
			<div class="row">
				<div class="col-12">
					<div class="sign__content">
						...
						<!-- authorization form -->
						<form action="{{url('Admin_Login')}}" class="sign__form"  method="post" enctype="multipart/form-data">
                        @csrf
							...
							<div class="sign__group">
								<input type="email" name="admin_email" class="sign__input" placeholder="Email" required>
							</div>

							<div class="sign__group">
								<input type="password" name="admin_password" class="sign__input" placeholder="Password" required>
							</div>
...
<!-- Mirrored from dmitryvolkov.me/demo/hotflix2.1/admin/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Apr 2022 19:53:12 GMT -->
</html>
